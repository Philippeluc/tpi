...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <ul class="nav navbar-nav">
            <li class="active"><a href="#"><b>Events Manager</b></a></li>
        ...
        <form class="navbar-form navbar-right inline-form">
            <div class="form-group">
                ...
                <a href="#" id="navbarlink"><span class="glyphicon glyphicon-cog"></span> Administration </a>
                <a href="#" id="navbarlink"><span class="glyphicon glyphicon-user"></span> Mon compte </a>
