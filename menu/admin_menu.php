...
* File : admin_menu.php
* Description : This file is the menubar for the authentified users (administrators)
* Version : 1.10
----------------------------------------------------------------->
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <form class="navbar-form navbar-right inline-form" method="GET" action="results.php">
            ...
            <button type="submit" name="search" id="navbarbutton" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span></button>
            <a href="administration.php" style="margin-right: 10px;"><span class="glyphicon glyphicon-cog"></span> Administration </a>
